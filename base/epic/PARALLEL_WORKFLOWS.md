...
- [AUDIT_WORKERS.md](../AUDIT_WORKERS.md) — Audit of worker response summarization; the two-channel model (summarized tool result for orchestrator, full events for desktop user).

...
- [ ] continue refininig skills and skill architecture audit (branch `audit/skill-architecture`)

## Release Process

- [ ] **Audit changelog** — Verify that all entries in `CHANGELOG.md` are concise, user-facing changes since v0.3.0.

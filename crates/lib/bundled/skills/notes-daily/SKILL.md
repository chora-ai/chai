...
- always specify `root` when working with notes in a subdirectory
...
When notes are in a subdirectory of the sandbox, specify `root` to point the resolver to the right directory. When omitted, the notes directory defaults to the sandbox root.

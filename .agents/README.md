...
- **[OLLAMA_REFERENCE.md](ref/OLLAMA_REFERENCE.md)** — How Ollama API is used, API capabilities, and differences from other APIs.
...
- **Workspace** (what's built, what’s next, comparing and testing different models) → add at **root**. Use a clear filename (e.g. `POC_DELIVERABLE.md`, `POC_IMPLEMENTATION.md`). Follow the general format and tone of other documents in the directory.

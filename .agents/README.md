...
- **Deliverable / Working Document** (what was built, what’s next) → add at **root**. Use a clear filename (e.g. `POC_DELIVERABLE.md`, `POC_IMPLEMENTATION.md`). Follow the general format and tone of other documents in the directory.

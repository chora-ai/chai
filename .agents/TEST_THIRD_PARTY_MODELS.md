...
This document describes a repeatable test procedure for comparing third-party hosted LLM performance with the agent. The same context and message sequence are used across models so results can be compared.
